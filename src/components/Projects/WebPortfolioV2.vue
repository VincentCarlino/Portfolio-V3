<template>
  <div class="bg home-bg">
    <div class="page-wrapper project-wrapper portfolio-v2">
      <h1 v-scroll-reveal>{{ name }} </h1>
      <div class="images">
        <div class="desktop"><Mockup v-scroll-reveal='{delay : 250}' :src="image"/></div>
      </div>
      <div class="article">
...
export default {
  ...
  data () {
      return ProjectData['portfolio-v2']
  }
}
</script>
